...
<hibernate-configuration>
    <session-factory>
        ...
        <property name="hibernate.query.mutation_strategy">org.hibernate.query.sqm.mutation.spi.SqmMutationStrategy</property>
        ...
        <mapping class="com.example.entity.Payment"/>
    </session-factory>
</hibernate-configuration>`;
}
